...
static bool less_than(symbol_c *s1, symbol_c *s2) {
  if (   (VALID_CVALUE( int64_iec, s1))
      && (VALID_CVALUE( int64_iec, s2))
      && (  GET_CVALUE( int64_iec, s1) < GET_CVALUE( int64_iec, s2)))
    return true;
...
void case_elements_check_c::check_subr_subr(symbol_c *s1, symbol_c *s2) {
  ...
  if (   (VALID_CVALUE( int64_iec, l1) || (VALID_CVALUE(uint64, l1)))
      && (VALID_CVALUE( int64_iec, l2) || (VALID_CVALUE(uint64, l2)))
      && (VALID_CVALUE( int64_iec, u1) || (VALID_CVALUE(uint64, u1)))
      && (VALID_CVALUE( int64_iec, u2) || (VALID_CVALUE(uint64, u2))))
...
void case_elements_check_c::check_subr_symb(symbol_c *s1, symbol_c *s2) {
  ...
  if (   (VALID_CVALUE(int64_iec, symb))
      && (VALID_CVALUE(int64_iec, lowl))
      && (VALID_CVALUE(int64_iec, uppl))
      && (  GET_CVALUE(int64_iec, symb) >= GET_CVALUE(int64_iec, lowl))
      && (  GET_CVALUE(int64_iec, symb) <= GET_CVALUE(int64_iec, uppl)))
