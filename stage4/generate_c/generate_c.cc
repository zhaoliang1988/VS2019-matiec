...
#ifndef _GENERATE_C_CC
#define _GENERATE_C_CC
  ...
  if (NULL != interval) {
    /* SYM_REF5(interval_c, days, hours, minutes, seconds, milliseconds) */
      ...
      if (NULL != interval->milliseconds) {
        if      (VALID_CVALUE( int64_iec, interval->milliseconds) &&           GET_CVALUE( int64_iec, interval->milliseconds) < 0) ERROR; // interval elements should always be positive!
      ...
      if (NULL != interval->seconds     ) {
        if      (VALID_CVALUE( int64_iec, interval->seconds     ) &&           GET_CVALUE( int64_iec, interval->seconds     ) < 0) ERROR; // interval elements should always be positive!
      ...
      if (NULL != interval->minutes     ) {
        if      (VALID_CVALUE( int64_iec, interval->minutes     ) &&           GET_CVALUE( int64_iec, interval->minutes     ) < 0) ERROR; // interval elements should always be positive!
      ...
      if (NULL != interval->hours       ) {
        if      (VALID_CVALUE( int64_iec, interval->hours       ) &&           GET_CVALUE( int64_iec, interval->hours       ) < 0) ERROR; // interval elements should always be positive!
      ...
      if (NULL != interval->days        ) {
        if      (VALID_CVALUE( int64_iec, interval->days        ) &&           GET_CVALUE( int64_iec, interval->days        ) < 0) ERROR; // interval elements should always be positive!
